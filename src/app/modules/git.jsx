...
const GitHubPortfolio = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-100 via-pink-50 to-sky-100 flex items-center justify-center">
        <div className="text-center">
          <div className="loading loading-spinner loading-lg text-primary mb-4"></div>
          <p className="text-lg text-gray-600">Loading GitHub data...</p>
        </div>
      </div>
    );
  }
